...
export default function InvoicesDialog({
  labelledBy,
  onClose,
  initialFocus,
  children,
  ...
  return (
    <div className="fixed inset-0 z-[75] bg-[#16233E]/40 flex items-center justify-center p-4">
      <div
        ...
        className="w-full max-w-[600px] max-h-[calc(100vh-48px)] overflow-y-auto bg-[var(--surface)] border border-[var(--border)] rounded-[12px] p-7"
      >
        {children}
      </div>
    </div>
