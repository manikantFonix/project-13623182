...
import type { RetailersState } from './data';

const options: { value: RetailersState; label: string }[] = [
...
export default function RetailersStateControl({
  state,
  onChange,
}: {
  state: RetailersState;
  onChange: (state: RetailersState) => void;
}) {
