...
function buildRequests(kind: RecordKind, seed: number, count: number): RecordRequest[] {
...
const RAW_CUSTOMERS: RawRecord[] = [
  { id: 'cu-marguerite', name: 'Marguerite Ellison', retailer: 'Aurora & Co', created: '2026-03-12', note: 'Prefers yellow gold. Sized at 6.5 last March.', email: 'marguerite.ellison@example.com', phone: '+1 415 555 0138', address: '18 Winthrop Road, Boston, MA 02116', requestCount: 4 },
  { id: 'cu-dario', name: 'Dario Fontana', retailer: 'Lune Atelier', created: '2026-04-03', note: 'Engagement piece — the partner is not to be contacted about it.', email: 'dario.fontana@example.com', phone: '+39 02 5555 0174', address: 'Via Solferino 22, 20121 Milano', requestCount: 2 },
  { id: 'cu-priya', name: 'Priya Raghunathan', retailer: 'Marchetti Fine Jewellery', created: '2026-04-21', note: 'Wedding set. Coordination goes through her sister.', email: 'priya.raghunathan@example.com', phone: '+44 20 7946 0231', address: '40 Pembridge Road, London W11 3HN', requestCount: 3 },
  { id: 'cu-edouard', name: 'Édouard Brissac', retailer: 'Saint-Clair Joailliers', created: '2026-05-02', note: null, email: 'edouard.brissac@example.com', phone: '+33 1 45 55 01 92', address: '7 Rue de Verneuil, 75007 Paris', requestCount: 1 },
  { id: 'cu-helena', name: 'Helena Whitfield', retailer: 'Ortega Goldsmiths', created: '2026-05-09', note: null, email: 'helena.whitfield@example.com', phone: '+44 161 555 0147', address: '3 Deansgate Mews, Manchester M3 2BW', requestCount: 0 },
  { id: 'cu-callum', name: 'Callum Baird', retailer: 'Ashford & Vine', created: '2026-05-18', note: 'Repeat client since 2021. Allergic to nickel.', email: 'callum.baird@example.com', phone: '+44 131 555 0188', address: '12 William Street, Edinburgh EH3 7NH', requestCount: 5 },
  { id: 'cu-ingrid', name: 'Ingrid Sørensen', retailer: 'Ravensworth', created: '2026-05-27', note: 'Prefers platinum. Quote only in euro.', email: 'ingrid.sorensen@example.com', phone: '+45 33 555 0121', address: 'Bredgade 41, 1260 København', requestCount: 2 },
  { id: 'cu-tomas', name: 'Tomas Alvarez', retailer: 'Aurora & Co', created: '2026-06-06', note: null, email: 'tomas.alvarez@example.com', phone: '+1 305 555 0163', address: '2200 Brickell Avenue, Miami, FL 33129', requestCount: 1 },
  { id: 'cu-beatrix', name: 'Beatrix Nolan', retailer: 'Lune Atelier', created: '2026-06-14', note: null, email: 'beatrix.nolan@example.com', phone: '+353 1 555 0119', address: '9 Fitzwilliam Square, Dublin D02', requestCount: 0 },
  { id: 'cu-rafael', name: 'Rafael Mendes', retailer: 'Marchetti Fine Jewellery', created: '2026-06-30', note: 'Family commission — three pieces, delivered together.', email: 'rafael.mendes@example.com', phone: '+351 21 555 0142', address: 'Rua Garrett 60, 1200-204 Lisboa', requestCount: 6 },
];
...
function toEntries(kind: RecordKind, raws: RawRecord[]): RecordEntry[] {
  return raws
    .map((raw, index) => ({
      ...raw,
      kind,
      requests: buildRequests(kind, index + 2, raw.requestCount),
    }))
...
export function filterRecords(
  ...
  return list.filter((record) => {
    if (term && !record.name.toLowerCase().includes(term) && !record.retailer.toLowerCase().includes(term)) {
      return false;
    }
...
export const RECORD_CONFIG: Record<RecordKind, RecordConfig> = {
  customers: {
    ...
    countNoun: 'customers',
    itemNoun: 'customer',
    searchPlaceholder: 'Search name or retailer',
    ...
    note: 'Read-only. Support changes go back to the retailer.',
    detailNote: 'Read-only. Support changes go back to the retailer.',
    detailVariants: ['several', 'none', 'no-note'],
  },
  manufacturers: {
    kind: 'manufacturers',
    ...
    note: 'Read-only. Inactive only means no new routing.',
    detailNote: 'Read-only. Inactive only stops new routing. Existing requests continue.',
