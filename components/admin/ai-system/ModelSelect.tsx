  ...
  return (
    <div ref={wrapRef} className="relative">
      <button
        ...
        className={`w-full h-9 pl-3 pr-9 rounded-full border border-[var(--border)] bg-[var(--muted)] flex items-center text-[13px] text-[var(--text)] whitespace-nowrap transition-colors duration-150 hover:bg-[var(--muted)] disabled:opacity-50 ${focusRing}`}
      >
