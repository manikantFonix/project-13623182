...
import type { AiSystemPreview } from './data';

const options: { value: AiSystemPreview; label: string }[] = [
  { value: 'default', label: 'Default' },
  { value: 'retry-2', label: 'Retry Limit 2' },
  { value: 'retry-5', label: 'Retry Limit 5' },
  { value: 'unsaved', label: 'Unsaved changes' },
  { value: 'retry-confirm', label: 'Retry Limit confirmation' },
  { value: 'saving', label: 'Saving' },
  { value: 'save-failed', label: 'Save failed' },
  { value: 'toggles-empty', label: 'Feature toggles empty' },
  { value: 'loading', label: 'Loading' },
  { value: 'error', label: 'Error' },
];

export default function AiSystemStateControl({
  state,
  onChange,
}: {
  state: AiSystemPreview;
  onChange: (state: AiSystemPreview) => void;
}) {
