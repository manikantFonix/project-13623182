...
export default function ActivityErrorState({ onRetry }: { onRetry: () => void }) {
  return (
    <div
      role="alert"
    ...
    >
      ...
      <p className="mt-2 text-[13px] leading-relaxed text-[var(--text-sec)]">
        The list failed to arrive, not the entries. Nothing has been read or written. Try again to
        reload it.
      </p>
      <button
        type="button"
