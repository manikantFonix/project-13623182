...
export default function DiscardDialog({
  ...
  return (
    <PromptsDialog labelledBy="discard-title" onClose={onCancel} initialFocus={safeRef}>
      ...
      <p className="mt-1.5 text-[12px] leading-relaxed text-[var(--text-sec)]">
        The prompt text has edits that have not been saved. Leaving now discards them and the
        current version stays as it is.
      </p>
