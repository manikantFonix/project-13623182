...
const options: { value: PromptsPreview; label: string }[] = [
  { value: 'populated', label: 'Complete category (Ring)' },
  { value: 'none', label: 'No category selected' },
  { value: 'incomplete', label: 'Incomplete set (Grillz)' },
  { value: 'viewing', label: 'Viewing a prompt' },
  { value: 'editing', label: 'Editing a prompt' },
  { value: 'unsaved', label: 'Unsaved changes' },
  { value: 'saving', label: 'Saving' },
  { value: 'save-failed', label: 'Save failed' },
  { value: 'history', label: 'Version history' },
  { value: 'old-version', label: 'Viewing an old version' },
  { value: 'rollback', label: 'Rollback confirmation' },
  { value: 'loading', label: 'Loading' },
  { value: 'error', label: 'Error' },
];

export default function PromptsStateControl({
  state,
  onChange,
}: {
  state: PromptsPreview;
  onChange: (state: PromptsPreview) => void;
}) {
