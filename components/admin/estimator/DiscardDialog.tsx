...
export default function DiscardDialog({
  ...
  return (
    <EstimatorDialog labelledBy="discard-title" onClose={onCancel} initialFocus={safeRef}>
      ...
      <p className="mt-1.5 text-[12px] leading-relaxed text-[var(--text-sec)]">
        The estimator settings below have not been saved. Leaving now returns them to their current
        values.
      </p>
