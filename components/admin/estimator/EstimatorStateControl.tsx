...
import type { EstimatorPreview } from './data';

const options: { value: EstimatorPreview; label: string }[] = [
  { value: 'default', label: 'Default' },
  { value: 'multiplier-changed', label: 'Multiplier changed' },
  { value: 'multiplier-refused', label: 'Multiplier refused' },
  { value: 'base-edited', label: 'Base days edited' },
  { value: 'unsaved', label: 'Unsaved changes' },
  { value: 'save-confirm', label: 'Save confirmation' },
  { value: 'saving', label: 'Saving' },
  { value: 'save-failed', label: 'Save failed' },
  { value: 'price-beyond-window', label: 'Price beyond window' },
  { value: 'api-not-configured', label: 'API never configured' },
  { value: 'loading', label: 'Loading' },
  { value: 'error', label: 'Error' },
];

export default function EstimatorStateControl({
  state,
  onChange,
}: {
  state: EstimatorPreview;
  onChange: (state: EstimatorPreview) => void;
}) {
