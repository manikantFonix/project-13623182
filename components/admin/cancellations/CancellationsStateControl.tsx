...
import type { CancellationsState } from './data';

const options: { value: CancellationsState; label: string }[] = [
  { value: 'populated', label: 'Populated' },
  { value: 'none', label: 'No cancellations' },
  { value: 'noReason', label: 'Nobody gave a reason' },
  { value: 'loading', label: 'Loading' },
  { value: 'error', label: 'Error' },
];

export default function CancellationsStateControl({
  state,
  onChange,
}: {
  state: CancellationsState;
  onChange: (state: CancellationsState) => void;
}) {
