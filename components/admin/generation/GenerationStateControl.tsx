...
export type LogPreview = 'populated' | 'none' | 'step' | 'loading' | 'error';

const options: { value: LogPreview; label: string }[] = [
  { value: 'populated', label: 'Populated' },
  { value: 'none', label: 'Nothing chosen' },
  { value: 'step', label: 'Step detail open' },
  { value: 'loading', label: 'Loading' },
  { value: 'error', label: 'Error' },
];

export default function GenerationStateControl({
  state,
  onChange,
}: {
  state: LogPreview;
  onChange: (state: LogPreview) => void;
}) {
