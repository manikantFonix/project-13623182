  ...
  return (
    <div className="rounded-[12px] border border-[var(--border)] bg-[var(--surface)] overflow-x-auto">
      <table className="w-full min-w-[760px]">
        ...
        <tbody>
          {packs.map((pack) => (
            <tr key={pack.size} className="border-b border-[var(--muted)] last:border-b-0">
              <th scope="row" className="pl-5 pr-4 py-4 text-left align-top font-normal">
                ...
                <span className="mt-0.5 block text-[12px] text-[var(--text-sec)]">Fixed size</span>
              </th>
