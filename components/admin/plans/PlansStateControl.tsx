...
const options: { value: PlansPreview; label: string }[] = [
  { value: 'populated', label: 'Populated' },
  { value: 'create', label: 'Creating a plan' },
  { value: 'edit', label: 'Editing a plan' },
...
export default function PlansStateControl({
  state,
  onChange,
}: {
  state: PlansPreview;
  onChange: (state: PlansPreview) => void;
}) {
