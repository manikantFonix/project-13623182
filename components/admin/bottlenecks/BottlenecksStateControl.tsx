...
import type { BottlenecksState } from './data';
import { focusRing } from '../tokens';

const options: { value: BottlenecksState; label: string }[] = [
  { value: 'attention', label: 'Attention needed' },
  { value: 'clear', label: 'All clear' },
  { value: 'error', label: 'Error' },
];

export default function BottlenecksStateControl({
  state,
  onChange,
}: {
  state: BottlenecksState;
  onChange: (s: BottlenecksState) => void;
}) {
