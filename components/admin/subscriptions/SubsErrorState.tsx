...
export default function SubsErrorState({ onRetry }: { onRetry: () => void }) {
  return (
    <div
      role="alert"
    ...
    >
      ...
      <h2 className="mt-4 text-[17px] font-semibold text-[var(--text)]">
        The list of subscriptions could not be loaded
      </h2>
      <p className="mt-2 text-[13px] leading-relaxed text-[var(--text-sec)]">
        The list failed to arrive, not the balances. Nothing has been changed. Try again to reload
        it.
      </p>
      <button
        type="button"
